        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" class="forms-sample" action="${pageContext.servletContext.contextPath}/buber" id="form">
                    ...
                    <button name="button_register" type="button" onclick="valid(document.getElementById('form'))" class="btn btn-gradient-primary mr-2"><fmt:message key="all.signin.create" bundle="${lang}"/></button>
